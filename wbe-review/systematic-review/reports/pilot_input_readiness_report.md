...
Generated: 2026-07-14T14:13:55.343671
...
- Pilot combinations missing from data/interim/pilot_search_log.csv: 3
...
- **[BLOCKING]** data/interim/pilot_search_log.csv has no populated rows (database + search_id). No real search has been logged yet.
...
- **[BLOCKING]** Pilot combination (database=pubmed, search_id=core) has no corresponding row in data/interim/pilot_search_log.csv.
- **[BLOCKING]** Pilot combination (database=scopus, search_id=module05) has no corresponding row in data/interim/pilot_search_log.csv.
- **[BLOCKING]** Pilot combination (database=wos, search_id=module02) has no corresponding row in data/interim/pilot_search_log.csv.
