...
USED = {
    ...
    "57": {"section": "6.1", "claim": "281-county event-detection framework reports sensitivity advantage over clinical-data baseline", "evidence": "Abstract-checked (⚠ preprint, metadata partial)", "overext": "No -- explicitly hedged with 'characterizes one model fit to one evidence base, not a transferable property' in the same sentence"},
