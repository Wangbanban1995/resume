...
{"target_section": "6.1", "paragraph_id": "P6-1", "condensed_claim": "Three surveillance objectives require different threshold logic; threshold set from asymmetric cost (§5.5), not convention; a recent preprint (Link/Garrido) reports a sensitivity advantage in a large U.S. county sample, but as a single non-peer-reviewed study this does not establish transferability -- threshold transportability must be re-validated per deployment. (Phase 3A Option C edit: specific 281-county figure removed as non-essential; 'a recent preprint reports...' framing and single-study/non-peer-reviewed/single-national-context caveats added.)",
 ...
 "omitted_detail": "Full statistical-process-control detection-rule discussion (§9.2's withdrawn-source design-philosophy point, per [56]'s withdrawal, not re-introduced); specific sensitivity 0.82/PPV 0.64 figures retained qualitatively only as 'substantial advantage', not restated as precise numbers; the specific 281-county figure itself was removed from the condensed text in Phase 3A as non-essential to the argument", "SI_destination": "S10 Expanded reporting checklist",
 "full_text_verification_required": "yes", "author_review_required": "no",
 "claim_type": "Empirical finding, evidence-anchored", "evidence_status": "Abstract-checked", "citation_support_scope": "Link/Garrido genuinely supports the sensitivity comparison for that one study; 'cannot be assumed transferable' is this review's own inference, explicitly flagged as such in the source draft's own §9.2 argument and now reinforced by the Phase 3A narrowing edit", "evidence_gap_priority": "**Critical** -- cross-city/cross-population transferability claim, single-study evidence, [57] itself still preprint (non-peer-reviewed)"},
